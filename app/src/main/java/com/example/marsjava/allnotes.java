    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ap1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(allnotes.this,Notes.class));
            }
        });
        ap2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(allnotes.this,Notes2.class));
            }
        });
        ap3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(allnotes.this,Notes3.class));
            }
        });
        ap4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(allnotes.this,Notes4.class));
            }
        });
        ap5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(allnotes.this,Notes5.class));
            }
        });
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(allnotes.this,login.class));
            }
        });
